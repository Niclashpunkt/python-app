...
class mainWindow(wx.Frame):
    def __init__(self,parent,id,title):
        ...
        dateEditLabel=wx.StaticText(self.mainPanel,-1,'label',(10,20))
        clientEditLabel=wx.StaticText(self.mainPanel,-1,'label',(10,40))
        activityEditLabel=wx.StaticText(self.mainPanel,-1,'label',(10,60))
        hoursEditLabel=wx.StaticText(self.mainPanel,-1,'label',(10,80))
        visitedEditLabel=wx.StaticText(self.mainPanel,-1,'label',(10,100))
